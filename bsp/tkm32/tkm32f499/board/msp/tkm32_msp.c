...
void tkm32_msp_usart_init(void *Instance)
{
    GPIO_InitTypeDef GPIO_InitStruct;
    UART_TypeDef *UARTx = (UART_TypeDef *)Instance;
...
#ifdef BSP_USING_SPI
void tkm32_msp_spi_init(void *Instance)
{
...
void tkm32_msp_sdio_init(void *Instance)
{
    ...
    {
        /* if used dma ... */
        RCC_AHB1PeriphClockCmd(RCC_AHBPERIPH_DMA2, ENABLE);

        RCC_AHB1PeriphClockCmd(RCC_AHBPERIPH_SDIO1, ENABLE);
...
#ifdef BSP_USING_PWM
void tkm32_msp_tmr_init(void *Instance)
{
    GPIO_InitType GPIO_InitStructure;
...
#ifdef BSP_USING_ADC
void tkm32_msp_adc_init(void *Instance)
{
    GPIO_InitType GPIO_InitStruct;
...
void tkm32_msp_hwtmr_init(void *Instance)
{
    TMR_Type *TMRx = (TMR_Type *)Instance;
...
#ifdef BSP_USING_CAN
void tkm32_msp_can_init(void *Instance)
{
    GPIO_InitType GPIO_InitStruct;
