...
typedef enum IRQn
{
    ...
    /******  TK499 CM4 specific Interrupt Numbers *********************************************************/
...
typedef struct
{
    ...
    __IO uint32_t AHB1RSTR;      /*!< RCC AHB1 peripheral clock register,           Address offset: 0x10 */
    __IO uint32_t AHB2RSTR;      /*!< RCC AHB2 peripheral clock register,           Address offset: 0x14 */
    __IO uint32_t APB1RSTR;      /*!< RCC APB1 peripheral clock register,           Address offset: 0x18 */
    __IO uint32_t APB2RSTR;      /*!< RCC APB2 peripheral clock register,           Address offset: 0x1C */
    __IO uint32_t AHB1ENR;       /*!< RCC AHB1 peripheral clock register,           Address offset: 0x20 */
    __IO uint32_t AHB2ENR;       /*!< RCC AHB2 peripheral clock register,           Address offset: 0x24 */
    __IO uint32_t APB1ENR;       /*!< RCC APB1 peripheral clock enable register,    Address offset: 0x28 */
    __IO uint32_t APB2ENR;       /*!< RCC APB2 peripheral clock enable register,    Address offset: 0x2C */
...
typedef struct
{
    __IO uint32_t TXREGA;       //0x00
    __IO uint32_t TXREGBL;      //0x04
    __IO uint32_t TXREGBH;      //0x08
    __IO uint32_t RXREG;        //0x0C
    __IO uint32_t CSTAT;        //0x10
    __IO uint32_t INTSTAT;      //0x14
    __IO uint32_t INTEN;        //0x18
    __IO uint32_t INTCLR;       //0x1C
    __IO uint32_t GCTL;         //0x20
    __IO uint32_t CCTL;         //0x24
    __IO uint32_t SPBRG;        //0x28
    __IO uint32_t RXDNR;        //0x2C
    __IO uint32_t SCSR;         //0x30
    __IO uint32_t EXTCTL;       //0x34
    __IO uint32_t TXNUM;        //0x38
    __IO uint32_t TRANSFMODE;   //0x3C
} SPI_TypeDef;
...
//BKP                                               //0x2400
//RESEVER                                           //0x2800
//WWDG                                              //0x2C00  //Maybe WWDG BASE is here
//12                                                //0x3000
//13                                                //0x3400
//14                                                //0x3800
//15                                                //0x3C00
...
#define RCC_AHB1ENR_BKPSRAMEN_Pos               (13U)
#define RCC_AHB1ENR_BKPSRAMEN_Msk               (0x1UL << RCC_AHB1ENR_BKPSRAMEN_Pos)    /*!< 0x00002000 */
...
#define RCC_AHB1ENR_LCDEN_Pos                   (31U)
#define RCC_AHB1ENR_LCDEN_Msk                   (0x1UL << RCC_AHB1ENR_LCDEN_Pos)        /*!< 0x80000000 */
#define RCC_AHB1ENR_LCDEN                       RCC_AHB1ENR_LCDEN_Msk

/******************  Bit definition for RCC_AHB2ENR register  ******************/
#define RCC_AHB2ENR_TK80EN_Pos                  (31U)
#define RCC_AHB2ENR_TK80EN_Msk                  (0x1UL << RCC_AHB2ENR_TK80EN_Pos)       /*!< 0x80000000 */
#define RCC_AHB2ENR_TK80EN                      RCC_AHB2ENR_TK80EN_Msk
